...
DERIBIT_HOST = "mercury.deribit.com"
DERIBIT_PORT = 9883
SOH = chr(1)
...
s.settimeout(10)
wrappedSocket = ssl._create_unverified_context().wrap_socket(s,server_hostname='deribit.com')

wrappedSocket.connect((DERIBIT_HOST, DERIBIT_PORT))
wrappedSocket.sendall(buff.encode('ascii'))
